...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:GridView ID="GridTipoEvento" runat="server" AutoGenerateColumns="False" BorderStyle="None" CellPadding="4"
        Height="78px" Width="100%" EmptyDataText="Não existe nenhum Tipo de Evento Cadastrado. Clique em incluir." ForeColor="#333333" AllowPaging="True" OnPageIndexChanging="GridTipoEvento_PageIndexChanging" PageSize="7">
