...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:GridView ID="GridSala" runat="server" AutoGenerateColumns="False" BorderStyle="None" CellPadding="4"
        Height="78px" Width="100%" EmptyDataText="Não existe nenhuma Sala cadastrada. Clique em incluir." ForeColor="#333333" AllowPaging="True" OnPageIndexChanging="GridSala_PageIndexChanging" PageSize="7">
